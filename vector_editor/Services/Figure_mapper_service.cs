...
namespace vector_editor.Services
{
    ...
    /// обратно в рабочую модель Figure_model соответствующего типа.
    /// </summary>
    public static class Figure_mapper_service
    {
        /// <summary>
        /// Создает модель фигуры по записи из файла.
        /// Возвращает null, если тип фигуры не распознан.
        /// </summary>
        public static Figure_model Create_model_from_record(Figure_record figure_record)
        {
