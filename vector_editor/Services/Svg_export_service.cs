...
namespace vector_editor.Services
{
    ...
    /// Формирует XML-документ с элементами rect, ellipse и line.
    /// </summary>
    public class Svg_export_service
    {
        /// <summary>
        ...
        {
            // Используем общий метод нормализации из Figure_model
            ...
            // Цвет #AARRGGBB содержит 9 символов — разделяем на RGB и прозрачность
